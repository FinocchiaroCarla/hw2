...
<body>
    ...
    <div id="right">
        ...
        <div class="title">PRESENTATI</div>
            ...
            <div class=uno>
                <div class="name">
                    <label>Nome<input type="text" name="name" value='{{ old("name") }}'>
                    <span></span>
                    </label>
                </div>

                <div class="surname">
                    <label>Cognome<input type="text" name="surname" value='{{ old("surname") }}'>
                    <span></span>
                    </label>
                </div>
            </div>
            ...
            <div class="email">
                <label>E-mail<input type="text" name="email" value='{{ old("email") }}'>
                <span></span>
                </label>
            </div>

            <div class="username">
                <label>Username<input type="text" name="username" value='{{ old("username") }}'>
                <span></span>
                </label>
            </div>
